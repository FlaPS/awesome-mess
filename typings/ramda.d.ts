...
declare namespace R {
    ...
    interface Static {
        ...
        /**
         * Full signature (D -> I -> O) -> (I -> D) -> I
         */
        chain<I, D, O>(fn2: CurryFn2<D, I, O>, fn1: Fn1<I, D>, input: I): O
        chain<I, D, O>(fn2: CurryFn2<D, I, O>, fn1: Fn1<I, D>) : Fn1<I, O>
        ...
        pick<T>(names: string[], obj: Dictionary<T>): Dictionary<T>;
        pick(names: string[]): <T>(obj: Dictionary<T>) => Dictionary<T>;
        /**
