...
/*
export const Message = <P, S>(consumer: IConsumer<S, {type:string, payload:P}, S>) =>
    Object.assign(...)*/
...
export const Pure = <P = Empty, M = Empty, E = Empty, S = Empty>(
    ...
    return Object.assign(
        ...
        value,
        {
            ...
            (component: {
                (props: ChildProps<P, M, E, S> & NewProps & { children?: any }, context?: any)
...
export type StateMapper<I, O> = (state: FrontState, props?: I) => O
