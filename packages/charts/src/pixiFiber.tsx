...
export type Pixic<T> = React.ComponentType<Partial<T>>
export type DisplayObjectProps = Partial<PIXI.DisplayObject>
export const BitmapText = TYPES.BITMAP_TEXT as any as Pixic<PIXI.extras.BitmapText>
export const Container = TYPES.CONTAINER as any as Pixic<PIXI.Container>
export const Graphics = TYPES.GRAPHICS as any as Pixic<PIXI.Graphics>
export const ParticleContainer = TYPES.PARTICLE_CONTAINER
export const Sprite = TYPES.SPRITE as any as Pixic<PIXI.Sprite>
export const Text = TYPES.TEXT as any as Pixic<PIXI.Text & { style?: Partial<PIXI.TextStyle> }>
